...
console.log(`2]. Arrow Function with 3 args & no return value,for received 3 parameters perform the multiplication..`);
var multiplication
...
console.log(`-------------------------------------------------------------------------------------------------------`);
console.log(`3]. Arrow Function with 5 args & return value such as, for received params it should do the addition`);
